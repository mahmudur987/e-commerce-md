...
import { useAboutUsReview, useSiteSetting } from "../../utils/Site";
...
export default function About() {
  ...
  useEffect(() => {
    if (siteData?.about_us_img.startsWith("/")) {
      setSrc(imageUrl + siteData?.about_us_img);
    }
  }, [siteData]);
  console.log(reviews);
  return (
          ...
          <div className="container-x mx-auto">
            <div className="w-full min-h-[665px] lg:flex lg:space-x-12 items-center pb-10 lg:pb-0">
              <div className="md:w-[570px] w-full md:h-[560px] h-auto rounded overflow-hidden my-5 lg:my-0 relative">
                <Image
                  layout="fill"
                  src={src ? src : `/assets/images/about-banner.png  `}
                  alt="about"
              ...
              <div className="content flex-1">
                ...
                <p className="text-[15px] text-qgraytwo leading-7 mb-2.5">
                  ...
                  {siteError ? siteError.message : "Error"}
                </p>
        ...
        <div className="customer-feedback w-full bg-white py-[60px]">
          ...
          <div className="feedback-slider-wrapper w-vw relative overflow-hidden">
            {reviews && reviews?.length > 0 ? (
              <SimpleSlider selector={slider} settings={settings}>
                {reviews &&
                  ...
                  reviews.map((review) => (
                    <div
                      key={review.id}
                      className="item h-[385px] bg-primarygray sm:px-10 sm:py-9 p-2"
                    >
                      <div className="flex flex-col justify-between h-full">
                        <div className="rating flex space-x-1 items-center">
                          <div className="flex items-center">
                            {Array.from(
                              Array(Math.floor(review?.rating ?? 1)),
                              () => (
              ...
              <ErrorComponent message={"No Reviews"} />
            )}
            {reviewsIsLoading && <LoadingSpinner />}
